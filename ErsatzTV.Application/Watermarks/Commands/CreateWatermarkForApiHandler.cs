...
public class CreateWatermarkForApiHandler : IRequestHandler<CreateWatermarkForApi, Either<BaseError, CreateWatermarkResult>>
{
    private readonly IDbContextFactory<TvContext> _dbContextFactory;

    public CreateWatermarkForApiHandler(IDbContextFactory<TvContext> dbContextFactory) =>
        _dbContextFactory = dbContextFactory;

    public async Task<Either<BaseError, CreateWatermarkResult>> Handle(
        CreateWatermarkForApi request,
    ...
    private static Validation<BaseError, ChannelWatermark> Validate(CreateWatermarkForApi request) =>
    ...
    private static Validation<BaseError, string> ValidateName(CreateWatermarkForApi request) =>
